...
class Pro{
	...
	static function home(){
		...
		$siteseopro_settings_tabs = [
			...
			'tab_siteseopro_breadcrumbs' => esc_html__('Breadcrumbs','siteseo'),
			'tab_siteseopro_robots_txt' => esc_html__('robots.txt','siteseo'),
			'tab_siteseopro_htaccess' => esc_html__('htaccess','siteseo'),
		];
		...
		// if(empty($sitesepro_license['license'])){
			...
			// </div>';
		// }
		echo'<span id="siteseo-tab-title"><strong>'.esc_html('SiteSEO - PRO','siteseo').'</strong></span>';
	...
	static function woocommerce_tab(){
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('WooCommerce','siteseo').'</h3>';
	...
	static function easy_digital_downloads_tab() {
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('Easy Digital Downloads','siteseo').'</h3>';
	...
	static function pagespeed_insights_tab(){
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('PageSpeed Insights','siteseo').'</h3>
	...
	static function dublin_core_tab(){
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('Dublin Core','siteseo').'</h3>';
	...
	static function local_business_tab(){
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('Local Business','siteseo').'</h3>';
	...
	static function structured_data(){
		...
		echo'<h3 class="siteseo-tabs">'.esc_html('Structured Data Types (schema.org)','siteseo').'</h3>';
	...
	static function breadcrumbs(){
		...
		echo'<h3 class="siteseo-tabs">' . esc_html__('Breadcrumbs', 'siteseo') . '</h3>
				...
				<td>
					<div class="siteseo-inner-tabs-wrap">
						...
						<div class="siteseo-inner-tab-content">
							...
							<pre>'.esc_attr('[siteseo_breadcrumbs]','siteseo').'</pre>
						</div>
		...
		echo '</div>
						<input type="text" style="width:200px" name="siteseo_pro_options[breadcrumbs_custom_seperator]" placeholder="'.esc_html__('Custom Separator', 'siteseo').'" value="'.esc_attr($custom_separator).'"/>
					</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div>
						...
						<br/><br/>
						<label>
							<input type="text" name="siteseo_pro_options[breadcrumb_home_label]" placeholder="'.esc_attr__('Homepage label', 'siteseo').'" value="'.esc_attr($home_label).'"/>
			...
			<tr>
				...
				<td>
					<div>
						<label>
							<input type="text" id="siteseo_breadcrumbs_prefix" name="siteseo_pro_options[breadcrumb_prefix]" placeholder="'.esc_attr__('Breadcrumb Prefix', 'siteseo'). '" value="'.esc_attr($prefix).'"/>
						</label>
					</div>
				</td>
			</tr>
	...
	static function robots(){
		...
		echo '<h3 class="siteseo-tabs">'.esc_html__('robots.txt','siteseo').'</h3><p>'. esc_html__('Manage your robots.txt file here. Adjust settings according to your SEO requirements.', 'siteseo') . '</p>';
		echo '<table class="form-table">';
		...
		if(!file_exists(ABSPATH . 'robots.txt')){
			...
			echo '<tr><th class="row">'.esc_html__('Preview', 'siteseo').'</th><td colspan="2"><a href="'.esc_url(get_home_url()).'/robots.txt" class="btn btnSecondary" style="text-decoration:none;" target="_blank">'.esc_html__('View Robots.txt', 'siteseo').'</a></td></tr>';
		}
	...
	static function htaccess(){
		...
		echo '<h3 class="siteseo-tabs">'.esc_html__('htaccess','siteseo').'</h3>
		<p class="description">'.esc_html__('Edit your .htaccess file to configure advanced settings for your site','siteseo').'</p>';
				...
				<tr>
					<th class="row"></th>
						<td colspan="2" class="siteseo-notice is-error">
							<p>'.esc_html__('Be careful editing this file. If any incorrect edits are made, your site could go down. You can restore the htaccess file by replacing it with the backup copy created by SiteSEO with name .htaccess_backup.siteseo', 'siteseo').'
							<br/><input type="checkbox" value="1" id="siteseo_htaccess_enable"/><strong>'.esc_html__('I understand the risk and I want to edit this file','siteseo').'</strong>
							</p>
		...
		echo '<table class="form-table" style="width: 100%;">
			<tr>
				<th class="row">'.esc_html__('Edit your htaccess file','siteseo').'</th>
				<td>
