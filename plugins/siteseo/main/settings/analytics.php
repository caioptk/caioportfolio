...
class Analytics{
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										'. wp_kses_post('<p class="description">To find your site ID, visit your <strong>Matomo Cloud </strong>account, go to Websites, and click Manage. The <br/>"Site ID" will be displayed on the right side. </p>', 'siteseo').'
										'.wp_kses_post('<p class="description">For self-hosted installations, navigate to your Matomo administration, then go to Settings, Websites, <br/> and Manage. From the list of websites, locate the "ID" line.</p>', 'siteseo').'
									</td>
								</tr>
	...
	static function clarity(){
		...
		<div class="siteseo-notice">
            		<span class="dashicons dashicons-info"></span>
           		 <p>'.sprintf(__('Create your first Microsoft Clarity project <a href="%s" target="_blank">here</a>.', 'siteseo'), esc_url('https://clarity.microsoft.com/')).'</p>
		</div>
				...
				<tr>
					...
					<td>
						...
						<p><span class="dashicons dashicons-external"></span>
							<a href="https://siteseo.io/docs/analytics/find-my-microsoft-clarity-project-id/?utm_source=plugin&utm_medium=wp-admin-help-tab&utm_campaign=siteseo" target="_blank">
	...
	static function save_settings(){
		...
		if(isset($_POST['siteseo_options']['custom_tracking_tab'])){
