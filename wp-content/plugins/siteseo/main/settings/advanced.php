			...
			<tbody>
				...
				<tr>
					...
					<td>
						<label>
							...
							'.wp_kses_post(__('Remove /<strong>product-category</strong>/ in your permalinks', 'siteseo-pro')).'
							</label>
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						'.wp_kses_post('<p class="description">If your site is already verified in <strong>Google Search Console</strong>, you can leave this field blank.</p>','siteseo').'
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						'.wp_kses_post('<p class="description">If your site is already verified in <strong>Bing Webmaster Tools</strong>, you can leave this field blank.</p>','siteseo').'
					</td>
				</tr>
