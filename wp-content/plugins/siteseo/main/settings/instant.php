...
class Instant{
        ...
        <div class="siteseo-notice">
            ...
            <div><h3>'.esc_html__('How does this work?', 'siteseo').'</h3>
                <ol><li>'.wp_kses_post(__('Setup your Google / Bing API keys from the <strong>Settings</strong> tab', 'siteseo')).'</li>
                    <li>'.wp_kses_post(__('<strong>Enter the URLs</strong> you want to index in the field below.', 'siteseo')).'</li>
    ...
    static function settings(){
		...
		$docs['instant_indexing']['google'] = 'https://siteseo.io/docs/api-cli-dev/use-google-instant-indexing-api-with-siteseo-pro/?utm_source=plugin&utm_medium=wp-admin-help-tab&utm_campaign=siteseo';
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        '</label>
                        <div class="siteseo_wrap_label">
                            <p class="description">'.esc_html__('Inform search engines via the IndexNow protocol (currently Bing and Yandex) whenever a post is created, updated, or removed.','siteseo').'</p>
                        </div>
                    </td>
                </tr>
