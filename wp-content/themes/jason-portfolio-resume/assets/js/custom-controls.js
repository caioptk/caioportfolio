...
(function($, api) {
   ...
   api.sectionConstructor['jason-portfolio-resume-upsell'] = api.Section.extend({
   ...
   const jason_portfolio_resume_section_lists = ['banner','skill','experience','gallery','blog','cta'];
   jason_portfolio_resume_section_lists.forEach(jason_portfolio_resume_homepage_scroll);

   function jason_portfolio_resume_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('jason_portfolio_resume_' + item + '_section', function(section) {
