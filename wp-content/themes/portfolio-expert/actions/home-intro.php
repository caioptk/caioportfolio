...
function portfolio_expert_intro_section_output($defult_img = '')
{
  $portfolio_expert_intro_img = get_theme_mod('portfolio_expert_intro_img', $defult_img );
    ...
    <div class="container">
      <div class="home-all-content">
        ...
        <?php if ($portfolio_expert_intro_img) : ?>
          <div class="hero-img">
            <img src="<?php echo esc_url($portfolio_expert_intro_img); ?>" alt="<?php echo esc_attr($portfolio_expert_intro_title); ?>">
          <?php else : ?>
