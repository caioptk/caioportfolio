 ...
 */
?>
<!-- wp:group {"style":{"background":{"backgroundImage":{"url":"<?php echo esc_url( get_stylesheet_directory_uri() );?>/assets/images/banner.png","id":4883,"source":"file","title":"banner"}}},"layout":{"type":"default"}} -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() );?>/assets/images/icon-6.png" alt="" class="wp-image-4888" style="width:44px;height:auto"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() );?>/assets/images/icon-6.png" alt="" class="wp-image-4888" style="width:40px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group pg-footer-center-row" style="border-top-color:#d092ba;border-top-width:1px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--20)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|40"}}}} -->
