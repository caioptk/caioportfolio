...
function wp_portfolio_next_previous_post_link() {
	if ( is_single() ) {
		...
		<div class="nav-links clearfix">
			<div class="nav-previous">
				<?php previous_post_link( '%link', '<span class="meta-nav">' . __( 'Previous', 'wp-portfolio' ) . '</span>'. '<span class="screen-reader-text">' . __( 'Previous post:','wp-portfolio') . '</span>' . ' <span class="post-title">%title </span>' ); ?>
			</div>
			<div class="nav-next">
				<?php next_post_link( '%link', '<span class="meta-nav">' . __( 'Next', 'wp-portfolio' ) . '</span>'. '<span class="screen-reader-text">' . __( 'Next post:','wp-portfolio') . '</span>'.'<span class="post-title">%title </span>' ); ?>
			</div>
		</div>
<?php
		}
